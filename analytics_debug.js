(function() {
    ...
    var ba = function(a) {
        ...
        Sc = function(a) {
            ...
            if (qd(b) || rd(b)) {
                var c = b[Ic];
                void 0 == c || Infinity == c || isNaN(c) ? L("Site speed data not sent - unsupported browser") : 0 < c ? (Rc(b, Kc), Rc(b, Nc), Rc(b, Mc), Rc(b, Jc), Rc(b, Lc), Rc(b, Oc), Rc(b, Pc), a(b)) : (L("Site speed data not available - waiting for onload"), Ca(Q, "load", function() {
                    Sc(a)
                }, !1))
        ...
        qd = function(a) {
            var b =
                Q.performance || Q.webkitPerformance,
                b = b && b.timing;
            if (!b) return !1;
    ...
    var va = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        vd = function(a, b) {
            ...
            c = a.get(Lb);
            if (c = aa(I.location[c ? "href" : "search"], "_ga")) a.get(Kb) ? (e =
    ...
    Z.P = function() {
        ...
        if (a && 42 == a.answer) J("Tracking script already loaded. Abandoning initialization.");
            ...
            df() || $b || !ye(new Ie(1E4)) || (L("Sending all Hits by SSL"), F(36), $b = !0);
